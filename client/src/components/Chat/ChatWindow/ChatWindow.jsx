...
export default function ChatWindow(props) {
    ...
    const {isMessagesLoading, isMessagesError, chat_messages, messages_error, refresh_messages} = useChatMessages(chat);
    const {isChatInfoLoading, isChatInfoError, chat_info, chat_info_error, refresh_chat_info} = useChatInfo(user_id, chat);
